...
interface Logger {
    ...
    fun logD(throwable: Throwable, message: String, vararg params: Any?)

    fun logI(message: String, vararg params: Any?)
    fun logI(throwable: Throwable, message: String, vararg params: Any?)

    fun logW(message: String, vararg params: Any?)
    fun logW(throwable: Throwable, message: String, vararg params: Any?)

    fun logA(message: String, vararg params: Any?)
    fun logA(throwable: Throwable, message: String, vararg params: Any?)
